...
namespace GilqEngine
{
    ...
    void Shader::addIntArr(const string &uniformName, int *value, u32 size)
    {
        TRACE();
    ...
    void Shader::updateIntArr(const string &uniformName, int *value, u32 size)
    {
        TRACE();
    ...
    void Shader::setIntArr(const string &uniformName, int *value, u32 size)
    {
        TRACE();
