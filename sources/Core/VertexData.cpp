...
namespace GilqEngine
{
    ...
    void VertexData::pushAttributeFloat2_dynamic(u32 instanceDivisor, u32 size, const vector<VertexAttributeFloat2> &value)
    {
        TRACE();
        _vertexVectorFloat2_dynamic.push_back({VertexVector<VertexAttributeFloat2>(value.begin(), value.end()), instanceDivisor, size});
    }

    void VertexData::pushAttributeFloat3_dynamic(u32 instanceDivisor, u32 size, const vector<VertexAttributeFloat3> &value)
    {
        TRACE();
        _vertexVectorFloat3_dynamic.push_back({VertexVector<VertexAttributeFloat3>(value.begin(), value.end()), instanceDivisor, size});
    }

    void VertexData::pushAttributeFloat4_dynamic(u32 instanceDivisor, u32 size, const vector<VertexAttributeFloat4> &value)
    {
        TRACE();
        _vertexVectorFloat4_dynamic.push_back({VertexVector<VertexAttributeFloat4>(value.begin(), value.end()), instanceDivisor, size});
    }

    void VertexData::pushAttributeMat4_dynamic(u32 instanceDivisor, u32 size, const vector<VertexAttributeMat4> &value)
    {
        TRACE();
    ...
    void VertexData::configureVAO()
    {
        ...
        u32 layoutIndex = 0;
        for (u32 bufferIndex = 0; bufferIndex < _vertexVectorFloat2_static.size(); ++bufferIndex)
        {
        ...
        for (u32 bufferIndex = 0; bufferIndex < _vertexVectorFloat3_static.size(); ++bufferIndex)
        {
        ...
        for (u32 bufferIndex = 0; bufferIndex < _vertexVectorFloat4_static.size(); ++bufferIndex)
        {
        ...
        for (u32 bufferIndex = 0; bufferIndex < _vertexVectorMat4_static.size(); ++bufferIndex)
        {
        ...
        for (u32 bufferIndex = 0; bufferIndex < _vertexVectorFloat2_dynamic.size(); ++bufferIndex)
        {
            _vertexBuffersFloat2_dynamic[bufferIndex].bind();
            u32 vertexAttrLayoutIndex = layoutIndex;
        ...
        for (u32 bufferIndex = 0; bufferIndex < _vertexVectorFloat3_dynamic.size(); ++bufferIndex)
        {
        ...
        for (u32 bufferIndex = 0; bufferIndex < _vertexVectorFloat4_dynamic.size(); ++bufferIndex)
        {
        ...
        for (u32 bufferIndex = 0; bufferIndex < _vertexVectorMat4_dynamic.size(); ++bufferIndex)
        {
    ...
    void VertexData::updateBufferFloat2(u32 layoutIndex, const void *data, u32 size)
    {
        TRACE();
    ...
    void VertexData::updateBufferFloat3(u32 layoutIndex, const void *data, u32 size)
    {
        TRACE();
    ...
    void VertexData::updateBufferFloat4(u32 layoutIndex, const void *data, u32 size)
    {
        TRACE();
    ...
    void VertexData::updateBufferMat4(u32 layoutIndex, const void *data, u32 size)
    {
        TRACE();
