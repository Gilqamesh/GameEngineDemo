...
GeneratorId ParticleGeneratorManager::addParticleGenerator(uint32 maxNewParticlesPerFrame, float maxLifeTime)
{
    TRACE();
...
void ParticleGeneratorManager::setParticlesPerFrame(GeneratorId generatorId, uint32 particlesPerFrame)
{
    TRACE();
