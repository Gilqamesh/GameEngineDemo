...
namespace GilqEngine
{
    ...
    class Shader
    {
        ...
        vector<pair<string, pair<int *, u32>>> _intArrUniforms;
    ...
    public:
        ...
        void addIntArr(const string &uniformName, int *value, u32 size);
        ...
        void updateIntArr(const string &uniformName, int *value, u32 size);
        ...
        void setIntArr(const string &uniformName, int *value, u32 size);
