...
namespace GilqEngine
{
    ...
    class VertexData
    {
        ...
        struct VertexAttribParams
        {
            ...
            u32 divisor; // for intanced drawing 'glVertexAttribDivisor
            u32 size;
        };
    ...
    public:
        ...
        void pushAttributeFloat2_dynamic(u32 instanceDivisor, u32 size, const vector<VertexAttributeFloat2> &value = vector<VertexAttributeFloat2>());
        void pushAttributeFloat3_dynamic(u32 instanceDivisor, u32 size, const vector<VertexAttributeFloat3> &value = vector<VertexAttributeFloat3>());
        void pushAttributeFloat4_dynamic(u32 instanceDivisor, u32 size, const vector<VertexAttributeFloat4> &value = vector<VertexAttributeFloat4>());
        void pushAttributeMat4_dynamic(u32 instanceDivisor, u32 size, const vector<VertexAttributeMat4> &value = vector<VertexAttributeMat4>());
         ...
         */
        void updateBufferFloat2(u32 layoutIndex, const void *data, u32 size);
        void updateBufferFloat3(u32 layoutIndex, const void *data, u32 size);
        void updateBufferFloat4(u32 layoutIndex, const void *data, u32 size);
        void updateBufferMat4(u32 layoutIndex, const void *data, u32 size);
